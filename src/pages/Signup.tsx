  ...
  return (
    <main className="container auth-page">
      ...
      <div style={{ display: "flex", flexDirection: "column", gap: "0.75rem" }}>
        ...
        <a href={`${authBaseUrl}/api/auth/github`} style={{ display: "flex", alignItems: "center", justifyContent: "center", gap: "0.5rem", padding: "0.75rem", background: "#1F2937", color: "#fff", border: "1px solid var(--border)", borderRadius: "0.5rem", fontWeight: 600, textDecoration: "none", transition: "var(--transition)" }} onMouseEnter={(e) => e.currentTarget.style.background = "#2d3748"} onMouseLeave={(e) => e.currentTarget.style.background = "#1F2937"}>
